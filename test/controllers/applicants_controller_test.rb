...
class ApplicantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create applicant" do
    assert_difference('Applicant.count') do
      post applicants_url, params: { applicant: { name: @applicant.name, vancancy_id: @applicant.vancancy_id } }
    end
  ...
  test "should update applicant" do
    patch applicant_url(@applicant), params: { applicant: { name: @applicant.name, vancancy_id: @applicant.vancancy_id } }
